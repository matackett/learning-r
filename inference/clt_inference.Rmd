...
CLT-based null null distribution. We indicate the test statistic with a red 
...
statistic. Then, calculate the $p$-value.

```{r ex4, exercise = TRUE, exercise.setup = "ex3-solution"}

```

```{r ex4-solution, exercise.setup = "ex3-solution"}
se <- s/sqrt(n)
t <- (xbar - 30) / se
t
