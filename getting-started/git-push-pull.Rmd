...
In the tutorial Getting Started with GitHub: Clone Repo + Start New RStudio Project [ADD LINK], you learned how to clone a repo and start a new project in RStudio. In this tutorial, we'll talk about how to pass updated files between RStudio and GitHub as you work on your analysis. 
...
You can now go to your repo repo on GitHub and see the updates!
...
The instructions from this tutorial were adapted from labs in [Data Science in a Box](https://datasciencebox.org/) by Mine Çetinkaya-Rundel.
