...
```{r canada, echo=TRUE, fig.width=5}
library(readxl)
library(tidyverse)
...
```{r colors, echo=TRUE, fig.width=5}
ggplot(Canada, aes(x = Percentage)) +
