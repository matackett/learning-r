...
Intuitively, and without calculating any numbers, is what we observed surprising 
assuming the null hypothesis is true?
...
```{r ex5, exercise = TRUE, exercise.setup = "ex3-solution"}

```

```{r ex5-solution, exercise.setup = "ex3-solution"}
null_dist %>%
  visualize() +
