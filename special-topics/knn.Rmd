...
We will use k-nearest neighbor to classify the penguins into three groups based on their measurements (more about this later). Before performing the classification, let's do a brief exploratory data analysis to take a look at the data. 
