...
Notice how the code used to define the color is inside of the `aes` function. This tells R to color the points based on the type of transmission (`am`). In other words, the color aesthetic is assigned to `am`. We have also added a label the legend and a subtitle.
...
```{r eval = F}
ggplot(data = mtcars, aes(x = hp, y = mpg, _______)) +
  geom_point(_______) +
  labs(x = "Horsepower", 
       y = "Miles per gallon",
       ____________,
...
```{r eval = F}
ggplot(data = mtcars, aes(x = ___, y = ___, _______)) +
  geom_point(_______) +
  labs(x = "Horsepower", 
       y = "Miles per gallon",
       __________,
...
ggplot(data = mtcars, aes(x = hp, y = mpg, color = cyl)) + 
  ...
  labs(x = "Horsepower", 
       ...
       title = "Horsepower vs. Miles per gallon",
       subtitle = "by Cylinder") + 
  scale_colour_viridis(palette = "______")
```
